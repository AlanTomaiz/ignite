...
export default function Register() {
  const { register, handleSubmit, setValue, formState: { errors, isSubmitting } } = useForm<RegisterSchema>({
    ...
    <Container>
      ...
      <Form as="form" onSubmit={handleSubmit(handleRegister)}>
        <label>
          ...
          <TextInput prefix="ignite.com/" placeholder="seu-usuario" crossOrigin="" {...register('username')} />
